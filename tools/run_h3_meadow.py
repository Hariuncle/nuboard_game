...
SHOTS = (
    {
        ...
        "prompt": (
            ...
            "Pomora, the exact fluffy white cat queen in pink petal mantle and heart crown, runs toward "
            "camera with real weight, blinking and turning toward the explosion. The Acorn Bomber at "
            "right completes a forceful overarm throw; the airborne acorn spins fast, strikes the path, "
            "and erupts into dirt, sparks, flower petals and a visible pressure wave. Grass, fur, petals "
            "and water react physically. Fast low camera dolly with strong parallax and a slight impact "
    ...
    },
    {
        ...
        "prompt": (
            ...
            "Pomora gives one decisive forward command with her raised paw, her expression shifting "
            "from concern to brave resolve, natural blink and breathing. Thorn Knight plants his feet "
            "and snaps the rose shield up as a glowing acorn projectile deflects off it in petals and "
            "gold sparks. Berry Archer pulls the bowstring fully and releases one pink flower arrow "
            "past camera. Fur, capes, ears and petals move from the action. Camera arcs quickly around "
    ...
    },
    {
        ...
        "prompt": (
            ...
            "first frame. The Acorn Bomber hops across the path with clear body rotation and throws a "
            "spinning acorn toward camera. Berry Archer pivots, draws and fires a flower arrow at it. "
            "The first-person pink wooden blossom blaster tracks the airborne acorn smoothly through "
